<?php
    ...
    try {
        ...
        echo "<h3 style=\"text-align:center;margin-top:200px;\">Please check your mail for the details of the Donations made.</h3>"."<br><br>"."<h4 style=\"text-align:center;\">You will be redirected to home page in 10 seconds.</h4>";
    } catch (Exception $e) {
